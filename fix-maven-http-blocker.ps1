...
<settings xmlns="http://maven.apache.org/SETTINGS/1.0.0"
    ...
    <mirrors>
        <!-- Use Aliyun mirror (HTTPS, fast, reliable) -->
        <mirror>
        ...
        <!-- Unblock HTTP repositories (for Maven 3.8.1+) -->
        <mirror>
...
Write-Host "`n✓ Maven settings fixed!" -ForegroundColor Green
Write-Host "`nSettings file: $settingsFile" -ForegroundColor Cyan
Write-Host "`nNow try:" -ForegroundColor Yellow

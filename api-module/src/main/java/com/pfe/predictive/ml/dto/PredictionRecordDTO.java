...
/**
 * DTO for PredictionRecord - used in list views and API responses.
 * Omits inputFeaturesSummary for brevity in paginated lists.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Prediction record from ML model")
